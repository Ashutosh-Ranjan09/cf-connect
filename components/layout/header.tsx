...
export const Header = () => {
  ...
  return (
    <header className={`sticky top-0 z-40 w-full transition-colors duration-200 ${scrolled ? 'bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60' : 'bg-transparent'}`}>
      <div className="container flex h-16 items-center justify-between py-4">
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <span className="hidden font-bold text-lg md:inline-block">CF-Connect</span>
          </Link>
          
          <h1 className="text-lg font-semibold md:inline-block">{getPageTitle()}</h1>
        </div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href={`/profile/${user.handle}`} className="cursor-pointer">
