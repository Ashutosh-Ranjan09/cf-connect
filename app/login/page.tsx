...
export default function LoginPage() {
  ...
  const onSubmit = async () => {
    try {
      const success = await login(form.getValues('handle'), form.getValues('password'));
      if (success) {
        toast({
  ...
  return (
    <div className="mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-6 flex min-h-screen flex-col items-center justify-center">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-card px-4 py-8 shadow sm:rounded-lg sm:px-10">
          <Form {...form}>
            <form className="space-y-6" onSubmit={form.handleSubmit(onSendOtp)}>
              <FormField
              ...
              {!otpSent ? (
                ...
                <div className="space-y-6">
                  <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-md flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-green-800 dark:text-green-300">OTP sent successfully</p>
