...
import { ChevronRight, BarChart, Users, Trophy, CalendarDays } from 'lucide-react';
      ...
      <main className="flex-1">
        <section className="py-20 md:py-28">
          <div className="container flex flex-col items-center text-center gap-4">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight tracking-tighter md:leading-none">
              Elevate Your Competitive Programming
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl">
              CF-Connect helps you track progress, analyze performance, and connect with other competitive programmers.
            </p>
        ...
        <section id="features" className="py-20 bg-muted/50">
          <div className="container">
            <h2 className="text-3xl font-bold text-center mb-12">Why CF-Connect?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-card rounded-lg p-6 shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Visualize your performance with interactive charts and detailed statistics.
                </p>
              </div>
              <div className="bg-card rounded-lg p-6 shadow-sm">
                <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
        ...
        <section id="about" className="py-20">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-6">About CF-Connect</h2>
              <p className="text-xl text-muted-foreground mb-8">
                CF-Connect was created by competitive programmers, for competitive programmers. 
                We understand the journey and built tools we wished we had when starting out.
              </p>
              <Button size="lg" asChild>
                <Link href="/dashboard">
                  Start Your Journey
